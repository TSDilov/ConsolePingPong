...
namespace PingPong
{
    public class Controller
    {
        ...
        public static void MoveBall(int firstPlayerBoardSize, int secondPlayerBoardSize, ref int ballPositionX, ref int ballPositionY, int firstPlayerPosition, int secondPlayerPosition, ref int firstPlayerResult, ref int secondPlayerResult, ref bool ballDirectionUp, ref bool ballDirectionRight, Drawer drawer)
        {
            if (ballPositionY == 0)
            {
            ...
            if (ballPositionX == Console.WindowWidth - 1)
            {
                ...
                ballDirectionUp = true;
                firstPlayerResult++;
                drawer.DrawIfFirtstPlayerScore();
            }
            if (ballPositionX == 0)
            {
                ballPositionX = Console.WindowWidth / 2;
                ...
                ballDirectionUp = true;
                secondPlayerResult++;
                drawer.DrawIfSecondPlayerScore();
            }
